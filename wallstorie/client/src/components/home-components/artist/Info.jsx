    ...
    <>
      <div className="px-6">
        ...
        <div className="flex flex-col justify-center items-center">
          <p className="text-gray-700 mt-2 font-lato mb-3">
            <span className="text-6xl flex justify-start items-start text-green-600 playfair">
              “
            </span>
          ...
          <h4 className="text-lg text-green-700 mb-3 max-w-xl font-lato">
            ...
            transform their stunning artwork into unique, high-quality
            wallpapers! Not only will your art be showcased to a wide audience,
            but you'll also earn a fair share of every sale.
          </h4>
        </div>
      </div>
    </>
