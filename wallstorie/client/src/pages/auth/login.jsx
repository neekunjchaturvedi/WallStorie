    ...
    <div className="w-full max-w-md p-8 space-y-3 rounded-xl dark:bg-green-50 dark:text-gray-800">
      ...
      <form noValidate="" action="" className="space-y-6">
        ...
        <div className="space-y-1 text-sm">
          ...
          />
          <div className="flex justify-end text-xs dark:text-gray-600 font-lato">
            <a rel="noopener noreferrer" href="#">
              Forgot Password?
            </a>
          </div>
        </div>
        <button className="block w-full p-3 text-center rounded-sm dark:text-gray-50 dark:bg-green-600 font-lato">
          Sign in
        </button>
      </form>
      <div className="flex items-center pt-4 space-x-1">
        <div className="flex-1 h-px sm:w-16 dark:bg-gray-300"></div>
        <p className="px-3 text-sm dark:text-gray-600 font-lato">
